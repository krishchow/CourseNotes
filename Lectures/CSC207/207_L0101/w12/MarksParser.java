...
public class MarksParser {
	...
	private void parseMarks() throws IOException {
		...
		try {
			...
			// This is for a simpler assign_marks.txt
			// You can build on this file and make it work with the "marks.txt" (as described on the review slides)
	...
	public static void main(String[] args) {
		// To test with marks.txt, change this here
		MarksParser mp = new MarksParser((MarksParser.class.getClassLoader().getResource("assign_marks.txt").getPath()));		
	}
}
