...
public class Balloon {
	// Example of UML: http://pages.cs.wisc.edu/~hasti/cs302/examples/UMLdiagram.html
	...
	public Balloon(String c){
		...
		this.capacity=100;
		this.isPopped=false;
		// numBalloons++; // start search locally and work up
		// this.numBalloons++; // start search at instance and work up
		Balloon.numBalloons++; // start search for variable name at bulletin board
	}
	...
	public String getColor() {
		...
		// CLASS.x means look at the bulletin board (class variables)
		return this.color; 
	}
	 ...
	 * @return the <b>number</b> of blas that splatted
	 */
	...
	public static void main(String [] args){
		...
		// b1=new Balloon("Red", 100); // Create and init a new Balloon then assign its phone number to b1
