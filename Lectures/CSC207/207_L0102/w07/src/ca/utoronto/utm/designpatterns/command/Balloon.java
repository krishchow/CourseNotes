...
public class Balloon {
	...
	/**
	 * Remove amount from this so long as this has at least 0
	 * Truing to remove more than this has leaves this with 0
	 * @param a the amount to be removed from this, must be positive
	 */
	...
	/**
	 * pop this, setting amount=capacity=0, this can no longer be
	 * inflated.
	 */
	public void pop(){
